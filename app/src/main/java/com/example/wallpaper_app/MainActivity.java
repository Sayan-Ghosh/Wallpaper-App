...
public class MainActivity extends AppCompatActivity {
    ...
    Adapter adapter;
    CardView mnature,mcar,mtrain,mtrending,msports,mheroes;
    EditText editText;
    ImageButton search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mheroes = findViewById(R.id.heroes);
        ...
        mheroes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String query = "superheroes";
                getsearchimage(query);
            }
        });
